...
public class TElementoAB<T> implements IElementoAB<T> {
    ...
    /**
     * Recorrida del árbol inOrden, retornando un string separado por guiones.
    ...
    /**
     * Recorrida del árbol inOrden, retornando una lista con los nodos.
    ...
    /**
     * Obtener la cantidad de hojas del árbol.
     */
    ...
    private TElementoAB quitaElNodo() {
        if (hijoIzq == null) return hijoDer;   // solo tiene un hijo o es hoja.
        if (hijoDer == null) return hijoIzq;   // solo tiene un hijo o es hoja.
