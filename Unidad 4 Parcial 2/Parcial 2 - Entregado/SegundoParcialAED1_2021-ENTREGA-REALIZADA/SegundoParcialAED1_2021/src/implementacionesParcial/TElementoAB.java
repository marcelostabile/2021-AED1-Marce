...
public class TElementoAB<T> implements IElementoAB<T> {
    ...
    public void indizar(Lista<Especialidad> especialidades) {
        ...
        Especialidad esp = (Especialidad) this.datos;
        TElementoAB<Especialidad> tesp = new TElementoAB<Especialidad>(esp.getNombreEspecialidad(), esp);
        INodo<Especialidad> nodo = especialidades.buscar(esp.getNombreEspecialidad() );
