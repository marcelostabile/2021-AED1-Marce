...
public class ManejadorArchivosGenerico {
	...
	public static void escribirArchivo(String nombreCompletoArchivo, String[] listaLineasArchivo) {
        FileWriter fw;
        try {
            fw = new FileWriter(Constantes.rutaArchivosSalida + nombreCompletoArchivo, true);
    ...
    public static String[] leerArchivo(String nombreCompletoArchivo) {
        ...
        try {
            fr = new FileReader(Constantes.rutaArchivosEntrada + nombreCompletoArchivo);
            ...
            System.out.println(nombreCompletoArchivo + "\n");
