...
public class ManejadorArchivosGenerico {
    ...
    public static String[] leerArchivo(String nombreCompletoArchivo){
        ...
        public static Integer[] leerArchivoInteger(String nombreCompletoArchivo){
        FileReader fr;
        ArrayList<Integer> listaLineasArchivo = new ArrayList<Integer>();
        try {
            fr = new FileReader(nombreCompletoArchivo);
            BufferedReader br = new BufferedReader(fr);
            String lineaActual = br.readLine();
            while (lineaActual != null){
                listaLineasArchivo.add(Integer.parseInt(lineaActual));
                lineaActual = br.readLine();
            }
        } catch (FileNotFoundException e) {
            System.out.println("Error al leer el archivo "+nombreCompletoArchivo);
        ...
        return listaLineasArchivo.toArray (new Integer [0]);
    }
    /**
