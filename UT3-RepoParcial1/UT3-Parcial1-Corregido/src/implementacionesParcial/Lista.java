...
// Pueden usar las implementaciones de lista que tengan del curso. 

public class Lista<T> implements ILista<T>{

    public INodo<T> primero;
    ...
    */
     ...
     * @param nodo nuevo
     */
    public void insertar(INodo<T> nodo) {    // Insertamos un nodo luego del último.
    ...
    public INodo<T> buscar(Comparable clave) {
        ...
        if (this.primero == null) {    // Lista vacia = retornamos nulo.
            return null;
        } 
        else {
